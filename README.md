...
Each time you want to publish:
 ...
 - Copy the tag to other tags:
   - `docker tag tsystem/mirth-connect:3.5.1 tsystem/mirth-connect:3`
   - `docker tag tsystem/mirth-connect:3.5.1 tsystem/mirth-connect:3.5`
   - `docker tag tsystem/mirth-connect:3.5.1 tsystem/mirth-connect:latest`
 - Push all the tags to Dockerhub:
   - `docker push tsystem/mirth-connect:3.5.1`
   - `docker push tsystem/mirth-connect:3.5`
